...
import { getAvatar } from "../../utils/generateImagens"
...
export function FollowItem({ name, username }) {
    ...
    return (
        <div className="flex items-center justify-between py-3 hover:bg-gray-800 transition duration-200">
            ...
            <button className="bg-blue-500 text-white font-bold px-4 py-2 rounded-full hover:bg-gray-300 transition duration-200">Seguir</button>
